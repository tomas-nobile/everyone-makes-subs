...
| Option | For | How |
|---|---|---|
| **Desktop app** | The production operator | Download the installer from the [latest release](../../releases/latest) and open it. It is unsigned: on **Windows** click *More info → Run anyway*; on **Mac** right-click the app → *Open*. The app opens the setup wizard |
